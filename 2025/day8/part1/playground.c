...
typedef struct {
  ...
  long long dist_sq; // Τετράγωνο της Ευκλείδειας απόστασης (για αποφυγή sqrt
                     // και float)
} Edge;
...
int main() {
  ...
  // Προσοχή: Για μεγάλο N, αυτό απαιτεί μνήμη. Για το puzzle αυτό είναι συνήθως
  // ασφαλές.
